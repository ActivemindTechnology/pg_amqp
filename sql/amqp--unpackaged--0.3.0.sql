...
ALTER EXTENSION amqp ADD function @extschema@.autonomous_publish(integer,character varying,character varying,character varying,character varying,boolean);
ALTER EXTENSION amqp ADD function @extschema@.publish(integer,character varying,character varying,character varying,character varying,boolean);
